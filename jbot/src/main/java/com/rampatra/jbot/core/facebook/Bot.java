...
import com.rampatra.jbot.core.facebook.models.Postback;
import com.rampatra.jbot.core.facebook.models.Response;
...
public abstract class Bot extends BaseBot {
    ...
    private void sendTypingOnIndicator(User recipient) {
        try {
            ...
            logger.error("Send typing on indicator error: Response body: {} \nException: ", e.getResponseBodyAsString(), e);
        }
    }
    ...
    private void sendTypingOffIndicator(User recipient) {
        try {
            ...
            logger.error("Send typing off indicator error: Response body: {} \nException: ", e.getResponseBodyAsString(), e);
        }
    }
